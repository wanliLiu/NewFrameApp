...
/**
 * 摘自：https://github.com/HotBitmapGG/RingProgressBar/blob/master/library/src/main/java/io/netopen/hotbitmapgg/library/view/RingProgressBar.java
 * 一个自定义的圆环进度条
 * 可适用于上传下载
 * @author Soli
 * @Time 2019/3/29 14:18
 */
